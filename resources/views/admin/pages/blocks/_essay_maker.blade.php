    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control input-style" name="blocks[{{ $block->pivot->id }}][sub_title]" value="{{ $block_content['sub_title'] ?? null }}">
            </div>
            <div class="form-group">
                <label class="input__label">{{ __('Sub Title 2') }}</label>
                <input type="text" class="form-control input-style" name="blocks[{{ $block->pivot->id }}][sub_title_2]" value="{{ $block_content['sub_title_2'] ?? null }}">
            </div>
            <div class="form-group">
                <label class="input__label">{{ __('Sub Text') }}</label>
                <textarea class="form-control ckeditor" id="ckeditor_{{ $block->pivot->id }}" name="blocks[{{ $block->pivot->id }}][sub_text]" rows="3">{{ $block_content['sub_text'] ?? null }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="input__label">{{ __('Info text') }}</label>
                <textarea class="form-control" rows="3" name="blocks[{{ $block->pivot->id }}][info_text]">{{ $block_content['info_text'] ?? null }}</textarea>
            </div>
        </div>
    </div>
</div>
